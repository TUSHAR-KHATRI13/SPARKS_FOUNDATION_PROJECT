  ...
  useEffect(() => {
    const fetchUserData = async () => {
      try {
        ...
        const userData = response.data.user; // Assuming 'user' is the key in response
    ...
    <div className="cbig">
      <div className="card">
        ...
        <div className="card-body">
          ...
          <p className="card-text">Your current balance</p>
      ...
      <Link to="/allcustomers">Back to Customer List</Link>
    </div>
  );
}
